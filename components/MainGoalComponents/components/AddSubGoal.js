  ...
  return (
    <div className="w-full h-auto flex justify-center">
      <div
        ...
        className="h-16 md:w-full w-52 border border-indigo-600 hover:bg-indigo-600 hover:text-white hover:scale-105 transition duration-200 rounded-2xl flex items-center justify-center p-4 cursor-pointer"
      >
