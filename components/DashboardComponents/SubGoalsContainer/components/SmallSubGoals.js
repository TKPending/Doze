const SmallSubGoals = ({ task, setIsModalVisible, setTaskClicked }) => {
    ...
    return (
        <div onClick={openModal} className="border border-indigo-600 h-20 w-[97%] hover:scale-105 transition duration-200 rounded-lg bg-white hover:cursor-pointer p-2">
